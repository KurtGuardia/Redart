...
export default function Navbar () {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 shadow-md z-[1001] h-16 transition-all duration-300 ${hasScrolled ? 'bg-white shadow-md' : 'bg-transparent'} ${isIndexPage
        ? hasScrolled
    ...
    >
      <div className='container mx-auto px-4 py-3 flex justify-between items-center h-full'>
        ...
        <div className='space-x-6 flex items-center'>
          <Link
            className={`text-lg ${isIndexPage && !hasScrolled ? 'text-white' : 'text-foreground'
