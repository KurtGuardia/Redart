    ...
    <>
      ...
      <HeroBackgroundSlider images={heroImages}>
        <div className='mx-auto z-10 text-center flex flex-col justify-between align-center bg-white bg-opacity-25 rounded-3xl py-8'>
          ...
          <Link
            href='/events'
            className='bg-[var(--white)] text-[var(--blue-500)] px-8 py-3 rounded-xl shadow-md text-sm font-semibold hover:bg-[#7928ca] hover:text-[var(--secondary-color)] transition duration-300 animate-fade-in-up w-fit mx-auto'
          >
            Explorar eventos
          </Link>
        </div>
      ...
      >
        <div className='w-[80%] relative min-h-[60vh] flex flex-col z-10 py-12 mx-auto px-4 text-center text-white'>
          ...
          <div className='text-center'>
            <Link
              href='/faq'
              className='text-[var(--secondary-color-foreground)] rounded-full text-sm font-semibold bg-[var(--white)] px-8 py-3 shadow-md hover:bg-[#7928ca] hover:text-[var(--secondary-color)] transition duration-300 animate-fade-in-up w-fit mx-auto'
            >
      ...
      <section className='map mt-24'>
        <div className='relative container mx-auto px-4 w-[80%]'>
          ...
          <h2 className='text-2xl font-bold text-center mb-8 bg-gradient-to-r from-[var(--blue-600)] to-[var(--blue-900)] bg-clip-text text-transparent px-6 py-3 rounded-lg'>
            Explora los espacios culturales
          </h2>
          <p className='text-center text-md font-light mb-12'>
      ...
      <section className='join text-center container mx-auto mb-48 mt-24'>
        <h2 className='text-2xl font-bold text-center mb-8 bg-gradient-to-r from-[var(--blue-600)] to-[var(--blue-900)] bg-clip-text text-transparent px-6 py-3 rounded-lg transform-gpu hover:scale-105 transition-transform'>
          ¿Quieres unirte a la comunidad de Radart?
        </h2>
        <p className='text-center text-md font-semibold max-w-2xl mx-auto mb-8 animate-fade-in-up'>
